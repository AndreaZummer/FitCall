...
function Header() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: 'app-header', children: [(0, jsx_runtime_1.jsx)("img", { id: "logo", alt: "logo", src: logo_png_1.default }), (0, jsx_runtime_1.jsx)("img", { className: "header-svgs", id: 'stop', alt: "stopwatch", src: stopwatch_svgrepo_com_svg_1.default }), (0, jsx_runtime_1.jsx)("img", { className: "header-svgs", id: 'watch', alt: "fitness watch", src: fitness_watch_pulse_smartwatch_svgrepo_com_svg_1.default }), (0, jsx_runtime_1.jsx)("img", { className: "header-svgs", id: 'bag', alt: "bag", src: gym_bag_barrel_svgrepo_com_svg_1.default }), (0, jsx_runtime_1.jsx)("img", { className: "header-svgs", id: 'shoe', alt: "shoe", src: shoe_5_svgrepo_com_svg_1.default }), (0, jsx_runtime_1.jsx)("img", { className: "header-svgs", id: 'dumbell', alt: "dumbell", src: dumbell_fitness_svgrepo_com_svg_1.default }), !userName ?
