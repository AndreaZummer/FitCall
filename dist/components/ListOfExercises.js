...
function ListOfExercises() {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: "exercises-container", children: (0, jsx_runtime_1.jsxs)("div", { className: "choice-column back", style: { backgroundImage: `url(${pexels_leonardho_1717096_jpg_1.default})` }, children: [(0, jsx_runtime_1.jsx)("div", { className: "overlay zak" }), (0, jsx_runtime_1.jsx)("div", { className: "display-container", children: currentItems.map((exercise, index) => {
                        return ((0, jsx_runtime_1.jsxs)("div", { className: "exercise-container", children: [(0, jsx_runtime_1.jsxs)("div", { className: "firstrow", children: [(0, jsx_runtime_1.jsx)("img", { alt: exercise.name, src: exercise.imageURL }), (0, jsx_runtime_1.jsxs)("div", { className: "popis", children: [(0, jsx_runtime_1.jsx)("span", { children: exercise.difficulty }), (0, jsx_runtime_1.jsx)("span", { id: 'equip', children: exercise.equipment })] })] }), (0, jsx_runtime_1.jsx)("h3", { children: exercise.name }), (0, jsx_runtime_1.jsx)("p", { children: exercise.description }), (0, jsx_runtime_1.jsxs)("div", { className: "lastrow", children: [(0, jsx_runtime_1.jsx)("label", { htmlFor: exercise.name, children: "Vyberte variantu" }), (0, jsx_runtime_1.jsxs)("select", { name: exercise.name, id: exercise.name, disabled: !exercise.repeat, onChange: inputChangeHandle, children: [(0, jsx_runtime_1.jsx)("option", { value: 'interval', children: "Intervaly" }), (0, jsx_runtime_1.jsx)("option", { value: 'opakovania', children: "Opakovania" })] }), (0, jsx_runtime_1.jsx)("input", { className: 'login', type: "submit", value: 'Prida\u0165 cvi\u010Denie', onClick: () => addExerciseHandle(exercise) })] })] }, exercise.name));
