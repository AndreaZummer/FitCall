...
function ListOfExercises() {
    ...
    function addExerciseHandle(selected) {
        const param = { selected, selectedType };
        store_1.default.dispatch((0, filterOfExercisesSlice_1.addSelected)(param));
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: "exercises-container", children: (0, jsx_runtime_1.jsxs)("div", { className: "choice-column back", style: { backgroundImage: `url(${pexels_leonardho_1717096_jpg_1.default})` }, children: [(0, jsx_runtime_1.jsx)("div", { className: "overlay zak" }), (0, jsx_runtime_1.jsx)("div", { className: "display-container", children: currentItems.map((exercise, index) => {
                        return ((0, jsx_runtime_1.jsxs)("div", { className: "exercise-container", children: [(0, jsx_runtime_1.jsxs)("div", { className: "firstrow", children: [(0, jsx_runtime_1.jsx)("img", { alt: exercise.name, src: exercise.imageURL }), (0, jsx_runtime_1.jsxs)("div", { className: "popis", children: [(0, jsx_runtime_1.jsx)("span", { children: exercise.difficulty }), (0, jsx_runtime_1.jsx)("span", { id: 'equip', children: exercise.equipment })] })] }), (0, jsx_runtime_1.jsx)(react_router_dom_1.Link, { to: `./${exercise.name}`, children: (0, jsx_runtime_1.jsx)("h3", { children: exercise.name }) }), (0, jsx_runtime_1.jsx)("p", { children: exercise.description }), (0, jsx_runtime_1.jsxs)("div", { className: "lastrow", children: [(0, jsx_runtime_1.jsx)("label", { htmlFor: exercise.name, children: "Vyberte variantu" }), (0, jsx_runtime_1.jsxs)("select", { name: exercise.name, id: exercise.name, disabled: !exercise.repeat, onChange: inputChangeHandle, defaultValue: "interval", children: [(0, jsx_runtime_1.jsx)("option", { value: 'interval', children: "Intervaly" }), (0, jsx_runtime_1.jsx)("option", { value: 'opakovania', children: "Opakovania" })] }), (0, jsx_runtime_1.jsx)("input", { className: 'login', type: "submit", value: 'Prida\u0165 cvi\u010Denie', onClick: () => addExerciseHandle(exercise.id) })] })] }, exercise.name));
                    }) }), (0, jsx_runtime_1.jsxs)("div", { className: "paginationButtons-container", children: [(0, jsx_runtime_1.jsx)("button", { disabled: currentPage === 1 ? true : false, onClick: () => setCurrentPage(1), children: '<<' }), (0, jsx_runtime_1.jsx)("button", { disabled: currentPage === 1 ? true : false, onClick: () => setCurrentPage(currentPage - 1), children: '<' }), (0, jsx_runtime_1.jsx)("div", { className: "paginationButtons", children: displayButtons() }), (0, jsx_runtime_1.jsx)("button", { disabled: currentPage * 12 > listOfExercises_1.listOfWorkouts.length ? true : false, onClick: () => setCurrentPage(currentPage + 1), children: '>' }), (0, jsx_runtime_1.jsx)("button", { disabled: currentPage * 12 > listOfExercises_1.listOfWorkouts.length ? true : false, onClick: () => setCurrentPage(Math.ceil(listOfExercises_1.listOfWorkouts.length / 12)), children: '>>' })] })] }) }));
}
