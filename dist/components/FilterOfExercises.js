...
function FilterOfExercises() {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: "full-size-container", children: (0, jsx_runtime_1.jsxs)("div", { className: "exercise-preview", children: [(0, jsx_runtime_1.jsx)("div", { className: "intendation" }), (0, jsx_runtime_1.jsxs)("div", { className: "personal-fit", style: { backgroundImage: `url(${personal_fit_background_jpg_1.default})` }, children: [(0, jsx_runtime_1.jsx)("div", { className: "overlay" }), (0, jsx_runtime_1.jsx)("div", { className: "fit", children: (0, jsx_runtime_1.jsx)("h2", { children: "Moje virtu\u00E1lne fitko" }) }), (0, jsx_runtime_1.jsx)("div", { className: "selectedExercises", children: context.selected && context.selected.map((exercise) => {
