...
const klik = new Workout(100, 'klik', 'Základný cvik na tricepsy a prsné svalstvo.', "Východisková poloha je vo vzpore kľačmo, ale hmotnosť tela je hlavne na horných končatinách, hlava smeruje v predĺžení chrbtice a pohľad medzi ruky, nepozeráme sa na pupok ani pred seba. S nádychom ideme nadol, pohybuje sa celý trup, chrbát je rovný, neprehýbame sa v bokoch, s výdychom ideme nahor.", require("./resources/push-up.jpg"), ["ruky"], 90, "stredné", 3, 30, 10);
const zamknutieVSede = new Workout(101, "Zamykanie v sede s extenziou bedrových kĺbov", "Statický cvik na spevnenie jadra tela.", "Zo sedu s vystretými a napnutými nohami pomaly klesáme trupom k zemi, akoby sme chceli zrolovať chrbát. V bode, keď sa k zemi blíži naša krížová kosť, napneme sedacie svaly a zároveň ťaháme hrudný kôš k panve, aby sme udržali nastavenú polohu chrbta. Správnou aktiváciou všetkých svalov sa naše nohy samy zdvihnú zo zeme a telom vytvoríme akoby kolísku. Pokiaľ nohy zdvihneme zo zeme vedome, cvik nie je vykonaný korektne. V polohe zotrváme dovtedy, pokiaľ sme schopní udržať maximálne svalové napätie.", require("./resources/zamknutie v sede.jpg"), ["brucho"], 30, "ťažké", 2);
const horolezec = new Workout(102, "Horolezec", "Cvik vychádzajúci z planku so zapojením brušných svalov.", "Nastavíme sa do vzporu na rukách a špičkách, keď má telo vytvárať akoby dosku od hlavy až po päty. Z tohto vzporu pomaly striedavo a s výdychom priťahujeme nohy k hrudníku. Kým sa jedna ťahá dopredu, na tej druhej o to viac strážime zapojenie sedacích svalov na správnu fixáciu panvy.", require("./resources/climber.jpg"), ["brucho", "kondička", "ruky"], 75, "stredné", 3, 30, 20);
...
const unozovanieVStoji = new Workout(112, "Unožovanie v stoji", "Jednoduché cvičenie na formovanie bočného zadku", "Postavíme sa vypriamene. Expander si dáme nad členky. S výdychom unožujeme najprv jednou nohou a následne druhú sériu druhou nohou.", require("./resources/unozovanie-v-stoji.jpg"), ["zadok"], 180, "stredné", 3, 30, 10, "expander");
const jumpingJack = new Workout(113, "Jumping Jack", "Kondičné cvičenie so zapojením celého tela", "Stojíme na šírku ramien. S odrazom odskočíme do strán a ruký vzpažíme cez upaženie. Vrátime naspäť.", require("./resources/JJ.jpg"), ["kondička"], 90, "ľahké", 3, 30);
const vypadVzad = new Workout(114, "Výpad vzad", "Základné cvičenie posilňujúce nohy, ktoré sa dá vykonávať aj so záťažou.", "Vychádzame zo stoje. Jednou nohou vykročíme vzad až kým kolenu nie je tesne nad zemou. Koleno prednej nohy sa pokrčí, ale zostáva presne nad pätou, nepadá dopredu.", require("./resources/vypad-vzad.jpg"), ["nohy", "zadok"], 90, "ľahké", 3, 30, 20);
const unozovanieVPlanku = new Workout(115, "Unožovanie v planku", "Cvik v ktorom zapojíme ramená, brucho aj zadok.", "Pripravíme si slidre. Dáme sa do základného plankového postavenia s tým, že si nohy položíme na slidre. Následne unožujeme tak, že nohu ťaháme so slidrom do 90° uhla.", require("./resources/plank-s-unozenim.jpg"), ["zadok", "brucho"], 90, "stredné", 2, 40, 10, "slider");
const biceps = new Workout(116, "Bicepsový zdvih", "Najzákladnejší cvik na ruky aký je.", "Vezmeme si činky do oboch rúk. Môžeme si kľaknúť alebo stáť vzpriamene. Naraz dvihneme obe činky pokrčením lakťa. Pri návrate dole lakte celkom nevystierame.", require("./resources/biceps.jpg"), ["ruky"], 90, "ľahké", 3, 40, 15, "činky");
const triceps = new Workout(117, "Tricepsová extenzia", "Cvik na posilnenie zadnej časti rúk.", "Vezmeme si činku. Môžeme sa postaviť alebo si kľaknúť. Ruky dáme dozadu za hlavu ohnuté v lakti. S výdychom lakte vystierame. Ruky s činkou držíme nad hlavou.", require("./resources/triceps.jpg"), ["ruky"], 90, "stredné", 3, 30, 12, "činky");
const roztahovanieKolien = new Workout(118, "Odťahovanie kolien v moste", "Cvik na posilnenie vnútorných stehien.", "Ľahneme si na chrbát na podložku. Expander si dáme nad kolená. Nohy pokrčíme v kolenách a dvihneme podsadenú panvu do mosta. Kolená s výdychom tlačíme od seba. S nádychom ich vrátime naspäť, ale nie úplne. Expander nechávame stále napnutý.", require("./resources/roztahovanie kolien.jpg"), ["nohy"], 90, "stredné", 3, 30, 10, "expander");
const krabiaChodza = new Workout(119, "Krabia chôdza", "Na vyformovanie zadku a stehien.", "Expander si dáme nad kolená. Zídeme mierne do podrepu s vystretým chrbtom. Chodíme do boku, čím naťahujeme expander.", require("./resources/krabia-chodza.jpg"), ["zadok"], 90, "stredné", 3, 30, undefined, "expander");
...
const ruskyTwist = new Workout(121, "Ruský twist", "Cvik na spevnenie brušného svalstva.", "Vezmeme si kettlebell. Posadíme sa na podložku s mierne pokrčenými nohami. Prejdeme do záklonu aby sme správne zapojili brucho. Závažie chytíme do rúk pred seba a následne robíme rotácie hornej časti tela striedavo do jednej aj druhej strany.", require("./resources/rusky-twist.jpg"), ["brucho"], 120, "ťažké", 4, 30, 20);
...
const plank = new Workout(123, "Plank", "Statická výdrž v planku.", "Nastavíme sa do yákladnej polohy. Ruky pod ramená, oddtláčame sa od lopatiek. Panva je podsadená, zapojený je stred tela. Staticky držíme.", require("./resources/plank.jpg"), ["ruky", "brucho"], 60, "ľahké", 2, 30);
const predpaženie = new Workout(124, "Predpaženie so záťažou", "Statická makačka na ruky.", "Vezmeme si činky a predpažíme pred seba do úrovne ramien, nie vyššie. Lakte úplne nedopíname. Držíme vo výdrži.", require("./resources/predpazenie.jpg"), ["ruky"], 60, "stredné", 3, 20, undefined, "činky");
const skakanieVPlanku = new Workout(125, "Preskoky v planku", "Cvik na zlepšenie kondícia a posilnenie tela.", "Nastavíme si základnú pozíciu planku. Podsadená panva, pozeráme rovno dole pod seba. Obojnožne robíme malé skoky do strán a späť.", require("./resources/plank-jack.jpg"), ["kondička", "ruky", "brucho"], 90, "ťažké", 3, 30);
const skracovackyHore = new Workout(126, "Skracovačky s vystretými nohami", "Posilníme priamé brušné svalstvo.", "Ľahneme si na chrbát a kríže priložíme k podložke. Podsadíme panvu a aktivujeme brušné svalstvo aby sa nám kríže neodlepili. Pomaly ťaháme hrudním smerom hore. Pozeráme priamo nad seba.", require("./resources/toe.jpg"), ["brucho"], 90, "stredné", 3, 30, 10);
const plankSPredpazenim = new Workout(127, "Plank s predpažením", "Posilníme brušné svalstvo.", "V tomto prípade budeme robiť plank na kolenách. Ruky sú pod ramenami a panva podsadená. Zadok nevystrčujeme. Pud ruky si dáme slidre tak, aby bol pred nami priestor. Na striedačku predpažujeme ruky kĺzaním sliderov.", require("./resources/plank-s-predpazenim.jpg"), ["brucho"], 90, "ťažké", 3, 25, 10, "slider");
...
const predklony = new Workout(135, "Predklony", "Jednoduchý cvik na zahriatie.", "Postavíme sa rovno na šírku ramien. Ruky dáme pokrčené za hlavu, lakťami von. Spevníme brucho a s výdychom sa predkloníme. Chrbát držíme celý čas rovný. Zídeme vrchnou časťou tela do pravého uhla a vrátime sa naspäť nahor.", require("./resources/predklony.jpg"), ["kondička"], 120, "stredné", 4, 30, 15);
...
const drepSVyponom = new Workout(140, "Drep s výponom", "Okrem precvičenia stehien a zadku si v tomto cvičení posilníme aj lýtka.", "Postavíme sa asi 3x širšie ako je panva. Špičky smerujú mierne šikmo, rovnako aj kolená. Urobíme drep. Váha je na celých chodidlách, kolená smerujú von a nepresahujú špičku. Päty odlepíme od zeme do výponu. Vrátime päty a vrátime sa do východzej polohy.", require("./resources/vypon.jpg"), ["nohy", "zadok"], 120, "stredné", 3, 40, 15)
const sikmyvypad = new Workout(141, 'Šikmý výpad', "Cvik na posilnenie svalov zadku a nôh.", "Postavíme sa rovno vzpriamene, vezmeme si závažie do rúk. S nádychom vykročíme jednou nohou šikmo dozadu za stojnú nohu. Stojná noha zostáva v pôvodnej polohe. Koleno nám nepadá, zostáva nad chodidlom. Stehno zadnej nohy sa snažíme držať čo najviac pri prednej nohe. Vrátime s výdychom.", require("./resources/sikmy-vypad.jpg"), ["nohy"], 150, "ťažké", 3, 40, 16, "kettlebell");
